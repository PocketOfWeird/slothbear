# -------------------------------------------------------------------------------------------------------
# Maya Submitter Script for the RenderPal V2 Submitter V2.15.0
...
# Example: g_rpSubmitterLocation = r"C:\Program Files\RenderPal V2\Submitter"
g_rpSubmitterLocation = r"C:\Program Files (x86)\RenderPal V2\Submitter"
